...
from .role_remove_permission_errors import RoleDoesNotExistError, PermissionDoesNotExistError, ListOfIDIsEmptyError
from ...types.permission_type import PermissionType


@strawberry.input
class RoleRemovePermissionInput(InputTypeInterface):
    role_id: ID

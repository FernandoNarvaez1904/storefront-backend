...
from sales.api.types.sale_document_type.sale_document_input import SaleDocumentCreateInput
from sales.api.types.sale_document_type.sale_document_type import SaleDocumentType
